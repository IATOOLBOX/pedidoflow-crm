...
// =========================================================================
// MÓDULO COBERTURA DE ENVÍOS (SHALOM VS CONTRAENTREGA LOCAL)
// =========================================================================
...
export type DepartmentCoverage = {
  ...
  primaryAgency: ShippingAgency;
  secondaryAgency?: ShippingAgency | undefined;
  shippingCost: number;
  advanceRequired: number; // S/ adelanto para emitir guía
  deliveryTime: string;
  allowsHomeDelivery: boolean;
  isActive: boolean;
  notes?: string | undefined;
};

export type ShippingPolicy = {
  defaultProvinceAdvance: number;
  freeShippingThreshold: number;
  allowLocalCodInProvinces: boolean;
  defaultLocalCost: number;
  shalomTrackingAutoNotify: boolean;
  paymentChannels: string[];
};

export const defaultShippingPolicy: ShippingPolicy = {
  defaultProvinceAdvance: 25,
  freeShippingThreshold: 150,
  allowLocalCodInProvinces: false,
  defaultLocalCost: 10,
  shalomTrackingAutoNotify: true,
  paymentChannels: ["Yape", "Plin", "BCP Transferencia", "Interbank"],
};

export const departmentsCoverage: DepartmentCoverage[] = [
  {
    id: "dep-lima",
    department: "Lima",
    capital: "Lima Metropolitana",
    zoneType: "Local (Contraentrega)",
    primaryAgency: "Motorizado Propio",
    secondaryAgency: "Olva Courier",
    shippingCost: 10,
    advanceRequired: 0,
    deliveryTime: "24 horas (Mismo día si pide antes de 2pm)",
    allowsHomeDelivery: true,
    isActive: true,
    notes: "Pago 100% al recibir en efectivo, Yape o Plin.",
  },
  {
    id: "dep-callao",
    department: "Callao",
    ...
    allowsHomeDelivery: true,
    isActive: true,
    notes: "Cobertura completa: Bellavista, La Perla, Carmen de la Legua.",
  },
  {
    id: "dep-arequipa",
    department: "Arequipa",
    capital: "Arequipa",
    zoneType: "Agencia Shalom",
    primaryAgency: "Shalom",
    secondaryAgency: "Marvisur",
    shippingCost: 15,
    advanceRequired: 25,
    deliveryTime: "48 horas",
    allowsHomeDelivery: true,
    isActive: true,
    notes: "3 agencias Shalom activas en Arequipa centro y Cono Norte.",
  },
  {
    id: "dep-lalibertad",
    ...
    allowsHomeDelivery: true,
    isActive: true,
    notes: "Entrega en Shalom Huanchaco y Trujillo Centro.",
  },
  {
    id: "dep-piura",
    department: "Piura",
    ...
    allowsHomeDelivery: true,
    isActive: true,
    notes: "Recojo preferencial en agencia Shalom Sullana y Piura.",
  },
  {
    id: "dep-cusco",
    department: "Cusco",
    ...
    allowsHomeDelivery: true,
    isActive: true,
    notes: "Agencia Shalom Wanchaq con alto flujo de recojo.",
  },
  {
    id: "dep-junin",
    department: "Junín",
    ...
    allowsHomeDelivery: true,
    isActive: true,
    notes: "Conexión directa vía Carretera Central.",
  },
  {
    id: "dep-lambayeque",
    ...
    allowsHomeDelivery: true,
    isActive: true,
    notes: "Agencias Shalom Leonardo Ortiz y Chiclayo Centro.",
  },
  {
    id: "dep-ica",
    department: "Ica",
    ...
    allowsHomeDelivery: true,
    isActive: true,
    notes: "Chincha, Pisco, Ica y Nazca con salidas diarias.",
  },
  {
    id: "dep-ancash",
    department: "Áncash",
    capital: "Huaraz / Chimbote",
    zoneType: "Agencia Shalom",
    primaryAgency: "Shalom",
    shippingCost: 15,
    advanceRequired: 25,
    ...
    allowsHomeDelivery: true,
    isActive: true,
    notes: "Salidas directas interdiarias a Callejón de Huaylas.",
  },
  {
    id: "dep-cajamarca",
    ...
    allowsHomeDelivery: true,
    isActive: true,
    notes: "Cajamarca y Jaén con recojo en Shalom.",
  },
  {
    id: "dep-tacna",
    department: "Tacna",
    ...
    allowsHomeDelivery: true,
    isActive: true,
    notes: "Zona sur frontera. Requiere DNI para emisión de guía.",
  },
  {
    id: "dep-sanmartin",
    department: "San Martín",
    capital: "Tarapoto / Moyobamba",
    zoneType: "Agencia Shalom",
    primaryAgency: "Shalom",
    secondaryAgency: "Olva Courier",
    shippingCost: 22,
    advanceRequired: 30,
    deliveryTime: "72 horas",
    allowsHomeDelivery: false,
    isActive: true,
    notes: "Recojo exclusivo en agencia Shalom Tarapoto.",
  },
  {
    id: "dep-loreto",
    department: "Loreto",
    capital: "Iquitos",
    zoneType: "Agencia Olva Courier",
    primaryAgency: "Olva Courier",
    shippingCost: 32,
    advanceRequired: 35,
    deliveryTime: "72 a 96 horas (Vía Aérea)",
    allowsHomeDelivery: true,
    isActive: true,
    notes: "Despacho aéreo por Olva Courier debido a acceso no terrestre.",
  },
  {
    id: "dep-ucayali",
    department: "Ucayali",
    ...
    allowsHomeDelivery: true,
    isActive: true,
    notes: "Agencia Shalom Pucallpa centro.",
  },
  {
    id: "dep-huanuco",
    department: "Huánuco",
    capital: "Huánuco / Tingo María",
    zoneType: "Agencia Shalom",
    primaryAgency: "Shalom",
    shippingCost: 16,
    advanceRequired: 25,
    ...
    allowsHomeDelivery: true,
    isActive: true,
    notes: "Cobertura en Huánuco y Tingo María.",
  },
  {
    id: "dep-puno",
    department: "Puno",
    capital: "Juliaca / Puno",
    zoneType: "Agencia Shalom",
    primaryAgency: "Shalom",
    secondaryAgency: "Marvisur",
    shippingCost: 20,
    ...
    allowsHomeDelivery: true,
    isActive: true,
    notes: "Alta demanda en Shalom Juliaca para comerciantes.",
  },
  {
    id: "dep-ayacucho",
    department: "Ayacucho",
    ...
    allowsHomeDelivery: true,
    isActive: true,
    notes: "Recojo en agencia Shalom Huamanga.",
  },
  {
    id: "dep-moquegua",
    department: "Moquegua",
    capital: "Moquegua / Ilo",
    zoneType: "Agencia Shalom",
    primaryAgency: "Shalom",
    shippingCost: 20,
    advanceRequired: 30,
    ...
    allowsHomeDelivery: true,
    isActive: true,
    notes: "Agencias en Moquegua ciudad y puerto de Ilo.",
  },
  {
    id: "dep-tumbes",
    department: "Tumbes",
    ...
    allowsHomeDelivery: true,
    isActive: true,
    notes: "Frontera norte vía Panamericana.",
  },
  {
    id: "dep-pasco",
    department: "Pasco",
    ...
    allowsHomeDelivery: false,
    isActive: true,
    notes: "Recojo en agencia Shalom Cerro de Pasco.",
  },
  {
    id: "dep-amazonas",
    department: "Amazonas",
    capital: "Chachapoyas / Bagua",
    zoneType: "Agencia Shalom",
    primaryAgency: "Shalom",
    shippingCost: 22,
    advanceRequired: 30,
    ...
    allowsHomeDelivery: false,
    isActive: true,
    notes: "Despacho con tránsito vía Chiclayo.",
  },
  {
    id: "dep-apurimac",
    department: "Apurímac",
    capital: "Abancay / Andahuaylas",
    zoneType: "Agencia Shalom",
    primaryAgency: "Shalom",
    shippingCost: 20,
    advanceRequired: 30,
    ...
    allowsHomeDelivery: false,
    isActive: true,
    notes: "Recojo en Shalom Abancay.",
  },
  {
    id: "dep-huancavelica",
    ...
    allowsHomeDelivery: false,
    isActive: true,
    notes: "Salidas interdiarias desde Lima.",
  },
  {
    id: "dep-madrededios",
    ...
    shippingCost: 25,
    advanceRequired: 35,
    deliveryTime: "72 a 96 horas",
    allowsHomeDelivery: false,
    isActive: true,
    notes: "Tránsito terrestre vía Interoceánica Sur.",
  },
];
